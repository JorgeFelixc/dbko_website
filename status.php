...
$infoXML = simplexml_load_string($info);
	...
	if ($h < 10) {$h = "0".$h;}
	if ($m < 10) {$m = "0".$m;}
	echo "<span class=\"online\">Ligado</span><br/>\n";
	echo "<span class=\"players\">Pessoas: <b>$online/$max</b></span><br/>\n";
	echo "<span class=\"uptime\">Lidado a: <b>$h:$m</b></span><br/>\n";
	echo "<span class=\"monsters\">Monstros: <b>".$infoXML->monsters['total']."</b></span><br/>\n";
} else {
	echo "<span class=\"offline\"> Server Desligado</span>";
}
?>